...
alias bld="cd ~/datom/build && cmake .. && make"
alias src="cd ~/datom/src"
alias lsoftcp="sudo lsof -iTCP -P -n"
alias datomterm="sudo nsenter -m -u -i -n -p -t $(docker inspect --format {{.State.Pid}}  datomdev)"
...
function task() {
    /home/nbayyana/datom/src/tools/task $@
}
export -f task
